...
function aistore_edit_vendor(){
    if (!is_user_logged_in())
    {
     ...
     global $wpdb;
      ...
      $company = aistore_books_getCompany($user_id);
       $vendor = $wpdb->get_row($wpdb->prepare("SELECT * FROM {$wpdb->prefix}aistore_books_vendor where id=%s and user_id=%s and company_id=%s ", $vendor_id,$user_id,$company->id));
	...
	toastr.success('Update Vendor Successfully');
	</script>
<?php

         $message='Update Vendor Successfully';
            sendNotification($vendor_id,$message); 
           $aistore_list_vendor_url = esc_url(add_query_arg(array(
                    'page_id' => get_option('aistore_list_vendor') ,
                ) , home_url()));
                
             //   header("Location: ".$aistore_list_vendor_url);
                
         ?>
        
    <meta http-equiv="refresh" content="0; URL=<?php echo esc_html($aistore_list_vendor_url); ?>" />  
...
<label for="Individual"><?php _e('Individual', 'aistore'); ?></label><br><br>
  ...
  <input class="input" type="text" id="vendor_name" name="vendor_name" value="<?php echo esc_attr($vendor->vendor_name);?>"><br>


  <label for="title"><?php _e('Email', 'aistore'); ?></label><br>
  <input class="input" type="text" id="vendor_email" name="vendor_email" value="<?php echo esc_attr($vendor->vendor_email);?>"><br><br>
 
  
  <label for="title"><?php _e('First Name', 'aistore'); ?></label><br>
  <input class="input" type="text" id="first_name" name="first_name" value="<?php echo esc_attr($vendor->first_name);?>"><br><br>
   
  <label for="title"><?php _e('Last Name', 'aistore'); ?></label><br>
  <input class="input" type="text" id="last_name" name="last_name" value="<?php echo esc_attr($vendor->last_name);?>"><br><br>
  
    <label for="title"><?php _e('Mobile', 'aistore'); ?></label><br>
  <input class="input" type="text" id="mobile_no" name="mobile_no" value="<?php echo esc_attr($vendor->mobile_no);?>"><br><br>
...
<?php echo esc_attr($vendor->address);?>
</textarea>
  
  
  
   <label for="city"><?php _e('City', 'aistore'); ?></label><br>
  <input class="input" type="text" id="city" name="city" value="<?php echo esc_attr($vendor->city);?>"><br><br>
   
  <label for="state"><?php _e('State', 'aistore'); ?></label><br>
  <input class="input" type="text" id="state" name="state" value="<?php echo esc_attr($vendor->state);?>"><br><br>
  
  <label for="zip_code"><?php _e('Zip code', 'aistore'); ?></label><br>
  <input class="input" type="text" id="zip_code" name="zip_code" value="<?php echo esc_attr($vendor->zip_code);?>"><br><br>
  
    <label for="pan_number"><?php _e('PAN Number' , 'aistore'); ?></label><br>
  <input class="input" type="text" id="pan_number" name="pan_number" value="<?php echo esc_attr($vendor->pan_number);?>"><br><br>
  
  <label for="gst_number"><?php _e('GST Number' , 'aistore'); ?></label><br>
  <input class="input" type="text" id="gst_number" name="gst_number" value="<?php echo esc_attr($vendor->gst_number);?>"><br><br>
