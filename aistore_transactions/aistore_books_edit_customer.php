...
<?php
           $message='Update Customer Successfully';
            sendNotification($customer_id,$message); 
            $aistore_list_customer_url = esc_url(add_query_arg(array(
                    'page_id' => get_option('aistore_list_customer') ,
                ) , home_url()));
            
             ?>
        
    <meta http-equiv="refresh" content="0; URL=<?php echo esc_html($aistore_list_customer_url); ?>" />  
...
<label for="Individual"><?php _e('Individual', 'aistore'); ?></label><br><br>
  ...
  <input class="input" type="text" id="customer_name" name="customer_name" value="<?php echo esc_attr($customer->customer_name);?>"><br>


  <label for="title"><?php _e('Email', 'aistore'); ?></label><br>
  <input class="input" type="text" id="customer_email" name="customer_email" value="<?php echo esc_attr($customer->customer_email);?>"><br><br>
 
  
  <label for="title"><?php _e('First Name', 'aistore'); ?></label><br>
  <input class="input" type="text" id="first_name" name="first_name" value="<?php echo esc_attr($customer->first_name);?>"><br><br>
   
  <label for="title"><?php _e('Last Name', 'aistore'); ?></label><br>
  <input class="input" type="text" id="last_name" name="last_name" value="<?php echo esc_attr($customer->last_name);?>"><br><br>
  
    <label for="title"><?php _e('Mobile', 'aistore'); ?></label><br>
    <input class="input" type="text" id="mobile_no" name="mobile_no" value="<?php echo esc_attr($customer->mobile_no);?>"><br><br>
...
<?php echo esc_attr($customer->address);?>"
</textarea>
  
  
  
   <label for="city"><?php _e('City', 'aistore'); ?></label><br>
  <input class="input" type="text" id="city" name="city" value="<?php echo esc_attr($customer->city);?>"><br><br>
   
  <label for="state"><?php _e('State', 'aistore'); ?></label><br>
  <input class="input" type="text" id="state" name="state" value="<?php echo esc_attr($customer->state);?>"><br><br>
  
  <label for="zip_code"><?php _e('Zip code', 'aistore'); ?></label><br>
  <input class="input" type="text" id="zip_code" name="zip_code" value="<?php echo esc_attr($customer->zip_code);?>"><br><br>
  
    <label for="pan_number"><?php _e('PAN Number' , 'aistore'); ?></label><br>
  <input class="input" type="text" id="pan_number" name="pan_number" value="<?php echo esc_attr($customer->pan_number);?>"><br><br>
  
  <label for="gst_number"><?php _e('GST Number' , 'aistore'); ?></label><br>
  <input class="input" type="text" id="gst_number" name="gst_number" value="<?php echo esc_attr($customer->gst_number);?>"><br><br>
         <input 
