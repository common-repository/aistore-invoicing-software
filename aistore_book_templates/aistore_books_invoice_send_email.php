     ...
     if (!is_user_logged_in())
    {
      ...
      $customer_id = sanitize_text_field($_REQUEST['customer_id']);
       $invoice_id = sanitize_text_field($_REQUEST['invoice_id']);
        ...
        $invoice= aistore_books_getinvoicerbyid($user_id,$company->id,$invoice_id);
...
$total_amount= $total_amount + $product->amount;
    				...
    				// 			' .$invoice->currency . ' '.$product->amount.'</td>
              ...
              $fee = $invoice->fee;
    				...
    				// 			'.$invoice->currency.' '.$total_amount.'</td>
    				// 			</tr>
    				// 			<tr>
    				// 				<td class="no-line"></td>
    				// 				<td class="no-line"></td>
    				// 				<td class="no-line text-center"><strong>Shipping</strong></td>
    				// 				<td class="no-line text-right">'.$invoice->currency .' '.$fee.'</td>
    				// 			</tr>';
...
<html>
	...
	<img src="'.$company->logo.'" style="width: 100%; max-width: 200px">
							...
							<!--	<img src="http://invoicingsoftware.blogentry.in/wp-content/uploads/documents/1/Screenshot-2022-03-01-at-16-29-17-Detalhes-QR-Code.png" style="width: 100%; max-width: 200px">-->
				...
				<tr class="item">
					...
					<td>'.$invoice->currency ." ".$product->amount.'</td>
				</tr>

				<tr class="item">
					<td>Fee</td>

					<td>'.$invoice->currency ." ". $fee.'</td>
				</tr>
				...
				<tr class="total">
					...
					<td>Total: 	'.$invoice->currency .' '.$total_amount.'</td>
				</tr>
			</table>
		</div>
	</body>
...
$file= aistore_books_html_pdf( $html,'aistore_book_invoice_'.$invoice_id.'.pdf' );
